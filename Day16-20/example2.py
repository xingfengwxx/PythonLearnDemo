...
def main():
    ...
    print('选择排序---1：', select_sort(items))
    print('冒泡排序---1：', bubble_sort(items))
    print('归并排序---1：', merge_sort(items))
    print('快速排序---1：', quick_sort(items))
    items2 = [
        Person('Wang', 25), Person('Luo', 39),
        Person('Zhang', 50), Person('He', 20)
    ]
    print('冒泡排序---2：', bubble_sort(items2, comp=lambda p1, p2: p1.age > p2.age))
    print('选择排序---2：', select_sort(items2, comp=lambda p1, p2: p1.name < p2.name))
    print('归并排序---2：', merge_sort(items2, comp=lambda p1, p2: p1.age <= p2.age))
    print('快速排序---2：', quick_sort(items2, comp=lambda p1, p2: p1.age <= p2.age))
    items3 = ['apple', 'orange', 'watermelon', 'durian', 'pear']
    print('冒泡排序---3：', bubble_sort(items3))
    print('冒泡排序---4：', bubble_sort(items3, comp=lambda x, y: len(x) > len(y)))
    print('归并排序---3：', merge_sort(items3))
    print('归并排序---4：', merge_sort(items3))
